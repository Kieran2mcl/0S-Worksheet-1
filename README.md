...
## Task 4 - Final Documentation and Reflection

In Task 4 I was required to write through the whole process of doing the worksheet and to justify what I did, produce results by screenshots and reflect on what I learned. In this section I will describe my learning and the knowledge I have picked up in the course of Tasks 1–3 and its practical experiences. Working through this worksheet allowed me to better understand the workings of computers at a lower level. While I was already familiar with C programming, when I translated something simple and very familiar like variables, loops, and conditionals into assembly code, I realised what was working “under the hood”. All operations abstracted away from you in a high-level language all had to be implemented via registers and memory addressing, stack frames and explicit jumps. That has allowed me to view how the CPU executes instructions step by step. The most important thing I learned was how a C programme can call a function written in assembly. Of course at first, this seemed really cryptic to me but once I grasped calling conventions and why asm_main must be declared global in assembly and cdecl in C, it then made clear how it is the compiler and assembler that act together during linking. Looking on both languages combined into the same executable made the link between high-level and low-level programming all the more tangible. This class really helped me to see the impact of C-level and assembly-level cooperation.

Task 2 involved writing a number of small but complicated assembly programmes. Reprogramming assembly if/else statements and loops forced me to think through comparisons, flags and jump instructions in order to implement a more polished code. The welcome-message task added the value of user input and validation, an experience that made it feel interactive, and introduced the behaviour of input routines and increased awareness of the language. The last array exercise was the most challenging and taught me how to handle memory, indexing, and dynamic values solely in assembly. Doing range validation, and summing subsets of arrays made me think about the power of properly addressing and precise control flow.

Task 3 included a build automation problem with Makefile. Before this, I was manually compiling every single programme with a long NASM and GCC command frame. Developing a Makefile taught me how significantly more efficient and professional it is to automate the entire build process. I had learned how Make identifies dependencies, how pattern rules reduce redundancy by allowing one rule to compile all .asm files, as well as how Make compares file timestamps to find out if it needs a new programme. A clean target also showed how build systems manage temporary files and tidy up projects. In summary, this assignment has demonstrated how to use a tool common in actual software development and operating systems projects. Taking notes throughout the README emphasised the need for clear communication and reproducibility in programming. Screenshots and explanations as well as small code snippets make the work comprehensible not just for a marker but for every reader (me included). This process also made me think about the problems which have shown up for me — incorrect include paths, linkage errors, logic errors — and my solution strategies.


--- Conclusion ---
Working on this worksheet has really increased my confidence in low-level programming. Now I get assembly, how assembly works, how it interacts with C, and how a build system converts source code into executables. I gained experience learning to structure a multi-file project, automate builds with Make, and have proper documentation. These are the skills needed to start a simple operating system on the next worksheet. Overall, this assignment has given me both the theoretical understanding and the practical skills needed for further study in operating systems and systems.